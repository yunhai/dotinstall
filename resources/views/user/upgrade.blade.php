                    ...
                    <form id='j-payment-form' class="form-c" method="POST" action="{{ route('user.upgrade') }}">
                        ...
                        <div class="form-group form-group-stripe mb-0 border-bottom-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <div id='card-holder' style='width: 420px; overflow: hidden; padding: 5px 10px;'>
                                        <div id="card-number" class='card-element' style='width: 200px;'></div>
                                        <div id="card-expiry" class='card-element' style='width: 75px;'></div>
                                        <div id="card-cvc" class='card-element' style='width: 120px;'></div>
                                    </div>
