        ...
        <div class="col-md-6" style='margin-left: 20px; flex: 0 0 48%; margin-top:2px;'>
            <form action="{{ route('top.search') }}" class="top-search">
                <div class="input-group">
                    ...
                    <button class="btn-search" style='padding: 0 10px;border-radius: 8px; padding-top:2px; border: solid 1px #ece8e9; font-size:12px;'>検索</button>
                </div>
            </form>
        </div>
...
<div class='row'>
  <div id='j-lessonFilterResult' style='width: 100%; display: block;'>
      @foreach($category as $category_id => $list)
