        ...
        <div class="col-md-6 fields-left">
            <div class="blog-content">
                ...
                <ul class="list-content">
                    <li><a href="#">１. xcode説明（全9回）</a><span class="pull-right">完了 / 0</span></li>
                    <li><a href="#">2.文字で遊んでみよう（全10回）</a><span class="pull-right">完了 / 0</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-6 fields-right">
            <div class="blog-content">
                <h2 class="blog_title blue text-center">swift入門<br>小学生コース</h2>
