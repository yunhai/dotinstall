                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item @if ($index === 0) active @endif" https://player.vimeo.com/video/286278638>
                        ...
                        @elseif ($item['type'] == YOUTUBE_TYPE_VIMEO)
                            <iframe class='vimeo-video' src="https://player.vimeo.com/video/{{ $item['youtube_id'] }}?autoplay=1&loop=1&autopause=0&api=1" width="100%" height="211" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
