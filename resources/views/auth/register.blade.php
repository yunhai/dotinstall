            ...
            <div class="row">
                ...
                <div class="col-2 pr-0">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist">
                        ...
                        <a class="nav-link" href="{{ route('register.diamond') }}" role="tab"><span class="mr-2"><img class="img-fluid" src="/img/charge_diamond.png" width="15px;"></span>アップグレード</a>
                            ...
                            <div class="tab-pane-user row">
                                <div class="col">
                                    <div class="card card-register">
                                        <div class="card-header">無料で新規登録（レッスン情報を取得できます）</div>
